...
@Configuration
@ConditionalOnExpression("${adapter-bank-spring-boot-starter.paymentServerFlowHandler.enabled:true}")
public class PaymentServerFlowHandlerConfiguration {
    ...
    public ServerFlowHandler<PaymentContext, PaymentProxyResult> paymentServerFlowHandler(
            ...
            SimpleRedirectWIthPollingStepResolverImpl simpleRedirectWIthPollingStepResolver,
        ...
        return new ServerFlowHandler<>(
                ...
                simpleRedirectWIthPollingStepResolver,
